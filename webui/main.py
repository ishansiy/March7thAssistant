...
if not TOKEN:
    raise RuntimeError("WEBUI_TOKEN must be configured as a Studio secret")
...
def get_current_user(authorization: Optional[str] = Header(None, alias="X-M7A-Token")) -> UserInfo:
